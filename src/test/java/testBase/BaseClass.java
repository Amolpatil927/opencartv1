...
public class BaseClass 
{
	...
	public void setup(String os, String br) throws IOException
	{
        ...
        if(execution_env.equalsIgnoreCase("remote"))
        {
            if(br.equalsIgnoreCase("chrome")) {
                ...
                driver = new RemoteWebDriver(URI.create("http://192.168.31.111:4444").toURL(), options);
            }
        ...
        else if(execution_env.equalsIgnoreCase("local"))
        {
            switch(br.toLowerCase())
            {
                ...
                default: System.out.println("Invalid browser name for local.."); return;
            }
        }
    ...
    public static String randomString(int length) {
        RandomStringGenerator generator = new RandomStringGenerator.Builder()
                .withinRange('a', 'z')  // lowercase letters
                .get();
    ...
    public static String randomNumeric(int length) {
        RandomStringGenerator generator = new RandomStringGenerator.Builder()
                .withinRange('0', '9')  // numbers + letters
                .get();
        return generator.generate(10);
    }
    public static String randomAlphaNumeric(int length) {
        RandomStringGenerator generator = new RandomStringGenerator.Builder()
                .withinRange('0', 'z')  // numbers + letters
